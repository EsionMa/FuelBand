<template>
  <div class="home-sleep">
    ...
    <div class="p-footer">
      <img class="footer-write" src="~images/write.png" alt="">
      <p class="p-comment">小编那么骚气，评论一下</p>
      <img class="footer-comment" src="~images/comment.png" alt="">
      <span class="footer-comment-count">5372</span>
    </div>
  </div>
</template>
